...
{
  //[Designer(typeof(CxsTranspControlDesigner))]
  public class CxsTranspControl:Control
  {
  ...
  //internal class CxsTranspControlDesigner : ControlDesigner
  //{
